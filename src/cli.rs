...
pub struct Arguments {
    ...
    pub verbose: usize,
    #[clap(short('p'), long, default_value = "3000", env("SERVER_PORT"))]
    /// The port for the Key-Value server to listen on.
    pub server_port: u16,
    #[clap(long, default_value = "6379", env("REDIS_PORT"))]
    /// The port for the Key-Value server to connect to Redis on.
    pub redis_port: u16,
    #[clap(short('s'), long, default_value = "localhost", env("SERVER_HOST"))]
    /// The address for the Key-Value server to listen on.
    pub server_host: Host,
    #[clap(short('r'), long, default_value = "localhost", env("REDIS_HOST"))]
    /// The address for the Key-Value server to connect to Redis on.
    pub redis_host: Host,
    #[clap(short, long, default_value = "1024", env("CONCURRENCY_LIMIT"))]
    ...
    #[clap(short, long, default_value = "10000", env("TIMEOUT_IN_MILLIS"))]
